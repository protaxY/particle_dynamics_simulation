...
class DPINet(nn.Module):
    def __init__(self, args, stat, phases_dict, residual=False, use_gpu=False):
        ...
        self.rigid_particle_predictor = None
        self.fluid_particle_predictor = None
        self.dust_particle_predictor = None
        if args.env == "DustBox":
            self.dust_particle_predictor = ParticlePredictor(nf_effect, nf_effect, args.position_dim)
        else:
